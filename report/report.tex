...
\begin{figure}[H]
    ...
    \begin{subfigure}
        \centering
        \includegraphics[scale=0.2]{img/orders.png}
    \end{subfigure}
    \caption{Menu du serveur et liste de commandes.}
    \label{fig:Menu-server}
\end{figure}

Le serveur sélectionne le numero de table pour laquel il va passer commande et après confirmation du numero de table, la carte va s'ouvrir. Il choissit la boisson en cliquant dessus et donne la quantité de boissons à commande. 
