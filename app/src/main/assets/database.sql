...
INSERT INTO "drinks" VALUES(8,'Côte du Rhône rouge',8,50,75,'Le Côte du Rhône rouge est un vin produit sur les rives droite et gauchedu Rhône entre Vienne et Avignon.','icon/COTRHONE',50,5,'Vin','Rouge');
INSERT INTO "drinks" VALUES(9,'Côte du Rhône rosé',8,25,75,'Le Côte du Rhône rosé est un vin produit sur les rives droite et gauchedu Rhône entre Vienne et Avignon.','icon/COTRHONE',25,5,'Vin','Rosé');
INSERT INTO "drinks" VALUES(10,'Côte du Rhône blanc',8,50,75,'Le Côte du Rhône blanc est un vin produit sur les rives droite et gauchedu Rhône entre Vienne et Avignon.','icon/COTRHONE',50,5,'Vin','Blanc');
...
INSERT INTO "drinks" VALUES(15,'Eau plate litre',4,200,50,'L''eau plate Chaudefontaine est une eau minérale naturelle faiblement minéralisée','icon/eau.jpg',200,20,'Eau','Plate');
INSERT INTO "drinks" VALUES(16,'Eau pétillante demi-litre',3,200,50,'S.Pellegrino est une eau délicieuse. Impression d''une fraîcheur qui picote sur la langue, puis d''une acidité modérée et une forte teneur en minéraux qui laisse un arrière-goût agréable, confèrent aujourd''hui à S.Pellegrino sa renommée internationale.','icon/eau.jpg',200,20,'Eau','Pétillante');
INSERT INTO "drinks" VALUES(17,'Eau pétillante litre',6,200,50,'S.Pellegrino est une eau délicieuse. Impression d''une fraîcheur qui picote sur la langue, puis d''une acidité modérée et une forte teneur en minéraux qui laisse un arrière-goût agréable, confèrent aujourd''hui à S.Pellegrino sa renommée internationale.','icon/eau.jpg',200,20,'Eau','Pétillante');
